  ...
  useEffect(() => {
    const fetchAllNews = async () => {
      try {
        setLoading(true);
        const queryParams = [];
        queryParams.push("category=hero");
    ...
    <div className="news-page">
      ...
      <div className="news-bg">
        <div className="news-banner">
          <label className="news-banner-title">HEROES & BOSSES</label>
          <label className="news-banner-sub">
           Latest updates concerning champions and their classes but also bosses npc
          </label>
        </div>
