  ...
  useEffect(() => {
    const fetchAllNews = async () => {
      try {
        setLoading(true);
        const queryParams = [];
        queryParams.push("category=realm");
    ...
    <div className="news-page">
      ...
      <div className="news-bg">
        <div className="news-banner">
          <label className="news-banner-title">REALMS & WORLDS</label>
          <label className="news-banner-sub">
            Latest worlds architecture is here, also you can find data about stronghold features
          </label>
        </div>
