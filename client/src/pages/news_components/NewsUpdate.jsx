  ...
  useEffect(() => {
    const fetchAllNews = async () => {
      try {
        setLoading(true);
        const queryParams = [];
        queryParams.push("category=update");
    ...
    <div className="news-page">
      ...
      <div className="news-bg">
        <div className="news-banner">
          <label className="news-banner-title">UPDATES & DEVELOPMENT</label>
          <label className="news-banner-sub">
            Latest code development and what happens behind the curtain can be found here
          </label>
        </div>
